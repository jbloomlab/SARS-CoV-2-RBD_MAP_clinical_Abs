...
```{r table, strong_sites_by_structure}
...
for(i in 1:nrow(dt)){
  dt$n_contact[i] <- nrow(temp[antibody==dt[i,"antibody"] & contact=="contact",])
  dt$n_contact_escape[i] <- nrow(temp[antibody==dt[i,"antibody"] & contact=="contact" & site_total_escape>cutoff,])
  dt$n_proximal[i] <- nrow(temp[antibody==dt[i,"antibody"] & contact=="proximal",])
  dt$n_proximal_escape[i] <- nrow(temp[antibody==dt[i,"antibody"] & contact=="proximal" & site_total_escape>cutoff,])
  dt$n_distal[i] <- nrow(temp[antibody==dt[i,"antibody"] & contact=="distal",])
  dt$n_distal_escape[i] <- nrow(temp[antibody==dt[i,"antibody"] & contact=="distal" & site_total_escape>cutoff,])
}
kable(dt)
```
