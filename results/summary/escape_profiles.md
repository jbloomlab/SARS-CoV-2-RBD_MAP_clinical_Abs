...
```
    ...
    Plotted profile 1 to:
     results/escape_profiles/REGN_and_LY-CoV016_stackedlogo.pdf
     results/escape_profiles/REGN_and_LY-CoV016_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_7.png)
    ...
    Plotted profile 5 to:
     results/escape_profiles/LY-CoV016_stackedlogo.pdf
     results/escape_profiles/LY-CoV016_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_9.png)
    ...
    Plotted profile 6 to:
     results/escape_profiles/LY-CoV016_color_by_bind_stackedlogo.pdf
     results/escape_profiles/LY-CoV016_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_11.png)
    ...
    Plotted profile 7 to:
     results/escape_profiles/LY-CoV016_color_by_expr_stackedlogo.pdf
     results/escape_profiles/LY-CoV016_color_by_expr_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_13.png)
    ...
    Plotted profile 8 to:
     results/escape_profiles/REGN_Baum_single_nt_stackedlogo.pdf
     results/escape_profiles/REGN_Baum_single_nt_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_15.png)
    ...
    Plotted profile 9 to:
     results/escape_profiles/REGN_Baum_single_nt_color_by_bind_stackedlogo.pdf
     results/escape_profiles/REGN_Baum_single_nt_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_17.png)
    ...
    Plotted profile 10 to:
     results/escape_profiles/REGN_Baum_single_nt_color_by_expr_stackedlogo.pdf
     results/escape_profiles/REGN_Baum_single_nt_color_by_expr_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_19.png)
    ...
    Plotted profile 11 to:
     results/escape_profiles/REGN_Baum_single_nt_color_escape_stackedlogo.pdf
     results/escape_profiles/REGN_Baum_single_nt_color_escape_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_21.png)
    ...
    Plotted profile 12 to:
     results/escape_profiles/REGN_Li_in_vivo_single_nt_color_escape_stackedlogo.pdf
     results/escape_profiles/REGN_Li_in_vivo_single_nt_color_escape_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_23.png)
    ...
    Plotted profile 13 to:
     results/escape_profiles/REGN_Baum_and_Li_single_nt_color_escape_stackedlogo.pdf
     results/escape_profiles/REGN_Baum_and_Li_single_nt_color_escape_stackedlogo.png.
