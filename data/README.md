...
This directory contains input data used for the analysis and configuration for some of the analyses:
 ...
 -  [spikeprot0111.fasta.tar.xz](spikeprot0111.fasta.tar.xz): A compressed FASTA file with all spike sequences in GISAID. Downloaded on Nov-12-2020 as follows: logged into GISAID, went to the *EpiCoV* page, clicked on *Downloads*, clicked on *spikeprot0111*, which yielded the file `spikeprot0111.fasta.tar.xz` which was then copied here.
