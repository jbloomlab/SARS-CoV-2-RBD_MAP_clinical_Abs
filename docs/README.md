...
The URL is `<username>.github.io/<repo name>` so for this specific project the URL is [https://jbloomlab.github.io/SARS-CoV-2-RBD_MAP_clinical_Abs/](https://jbloomlab.github.io/SARS-CoV-2-RBD_MAP_clinical_Abs/).
